...
$today_true_reg_data = getSQLdata($mysqli, $today_true_reg_sql);
$today_true_reg = ($today_true_reg_data && isset($today_true_reg_data['total'])) ? $today_true_reg_data['total'] : 0;
